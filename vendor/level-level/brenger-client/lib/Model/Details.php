...
class Details implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['floor_level'] = $data['floor_level'] ?? null;
        $this->container['elevator'] = $data['elevator'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['situation'] === null) {
            $invalidProperties[] = "'situation' can't be null";
        }
        if ($this->container['floor_level'] === null) {
            $invalidProperties[] = "'floor_level' can't be null";
        }
        if ($this->container['elevator'] === null) {
            $invalidProperties[] = "'elevator' can't be null";
        }
