...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://external-api.brenger.nl/v1';
    ...
    {
        $report  = 'PHP SDK (BrengerClient) Debug Report:' . PHP_EOL;
            ...
            [
                ...
                "variables" => [
                    "environment" => [
                        ...
                        "default_value" => "external-api.brenger.nl",
                    ],
                    "port" => [
                        "description" => "No description provided",
                        "default_value" => "443",
